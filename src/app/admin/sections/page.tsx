...
import { SaveBar, AdminToggle, createAdminSaveHandler, loadAdminContent } from "@/components/admin/AdminForm";
...
export default function SectionsAdmin() {
  ...
  useEffect(() => {
    loadAdminContent<SectionConfig[]>("sections").then(setSections);
  }, []);
  ...
  return (
    <div className="flex min-h-screen bg-brand-dark">
      ...
      <main className="ml-64 flex-1 p-8">
        <SaveBar
          onSave={createAdminSaveHandler("sections", () => sections, setSections)}
